sendPost = function(){
    ...
    var form = $('<form method="post" action="http://localhost/NlToPivotRules/resources/rest/dependenciesToPivot" name="dopost" style="display:none;"><input type="text" name="lang" value="en" /></form>');
    $('body').append(form);
    $(form).submit();
